...
#
#
function i = plotState(XL_true, XL_guess, XR_true, XR_guess)
#plot landmarks
hold on;
plot3(XL_true(1,:),XL_true(2,:),XL_true(3,:),'b^',"linewidth",2);
hold on;
plot3(XL_guess(1,:),XL_guess(2,:),XL_guess(3,:),'r^',"linewidth",2);
hold on;
#plot poses
for i=1:size(XR_guess,3)
plot3(XR_guess(1,4,i),XR_guess(2,4,i),XR_guess(3,4,i),'rd',"markersize",30,"linewidth",3);
hold on;
plot3(XR_true(1,4,i),XR_true(2,4,i),XR_true(3,4,i),'bd',"markersize",30,"linewidth",3);
hold on;
endfor
